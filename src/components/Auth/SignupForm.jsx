...
const SignupForm = () => {
    ...
    const updateUserInfo = async () => {
        ...
        let avatarUrl =
            'https://firebasestorage.googleapis.com/v0/b/jsi-project-cfc82.appspot.com/o/avatar%2Fdefault-avatar.png?alt=media&token=64779989-ca0e-47ec-8485-4e6e6ee801a8';
        if (avatar) {
