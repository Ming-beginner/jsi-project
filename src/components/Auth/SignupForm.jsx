                ...
                <Form noValidate onSubmit={handleSubmit} className='w-100 d-flex flex-column'>
                    <div className='d-flex w-100 flex-column flex-md-row align-items-center me-2'>
                        <div className='d-flex flex-column justify-content-center w-100'>
                            <Form.Group md='3' controlId='validationFormik03' className='mb-3'>
                            ...
                            <Form.Group md='3' controlId='validationFormik04' className='mb-3'>
                        ...
                        <div className='w-100 ms-2'>
                            ...
                            <Form.Group md='3' className='position-relative mb-3' controlId='validationFormik06'>
                            ...
                            <Form.Group md='3' className='mb-3' controlId='validationFormik07'>
                    ...
                    <Button type='submit' className='w-50 align-self-center'>Sign up</Button>
                </Form>
        )}
        </Formik>
    </div>
