...
const Setting = () => {
  ...
  const formSchema = yup.object().shape({
    ...
    bio: yup.string().max(100, 'Bio cannot be more than 50 characters long'),
  });
  ...
  const handleUpdateUserData = async (values) => {
    ...
    const commentQuerySnapshot = await getDocs(commentQ);
  ...
  if (currentUser) {
    return (
      ...
      >
        ...
        />
        <Loading isLoading={uploading || profileUpdating || passwordUpdating} />
        ...
        <div className='mt-3'>
            ...
            overlay={
              currentUser.providerData[0].providerId === 'google.com' ? (
                <Popover id='popover-basic'>
                  ...
                  <Popover.Body>
                    You are using Google as the provider so you cannot use this
                    feature.
                  </Popover.Body>
                </Popover>
              ) : (
          ...
          >
            <div>
              <div
                className={clsx('bg-white border border-dark w-100', {
                  'not-allowed':
                    currentUser.providerData[0].providerId === 'google.com',
                })}
              ...
              >
                <div className='border-bottom w-100 d-flex '>
                  ...
                  <div className='d-flex flex-column ms-2 p-1'>
                    <p className='fw-bold fs-5 m-0'>Change password</p>
                    ...
                    >
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          isValid={touched.new && !errors.new}
                      ...
                      >
                        ...
                        <Form.Control
                          ...
                          onChange={handleChange}
                          onBlur={handleBlur}
                          isValid={touched.newConfirm && !errors.newConfirm}
                          isInvalid={errors.newConfirm}
                        />
                        <Form.Control.Feedback type='invalid'>
                          {errors.newConfirm}
                        </Form.Control.Feedback>
